...
const RoomDetail = () => {
  ...
  const getTenantBadge = (type) => {
    switch (type) {
      case "BOYS":
        return { color: "bg-blue-600 text-white", label: "Boys Only" };
      case "GIRLS":
        return { color: "bg-pink-600 text-white", label: "Girls Only" };
      case "FAMILY":
        return { color: "bg-purple-600 text-white", label: "Family" };
      default:
        return { color: "bg-gray-800 text-white", label: "Anyone" };
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-32 lg:pb-10 font-sans selection:bg-blue-100">
      ...
      <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-lg border-b border-gray-100 px-4 lg:px-8 h-16 flex items-center justify-between shadow-sm">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-slate-600 hover:text-black font-medium transition-all hover:-translate-x-1"
        >
          <ArrowLeft size={20} /> <span className="hidden sm:inline">Back</span>
        </button>
        <span className="font-bold text-lg truncate max-w-[200px] lg:max-w-none text-slate-800">
          {room.title}
        </span>
        <button
          onClick={handleShare}
          ...
          <div className="lg:hidden space-y-6">
            <div>
              <div className="flex flex-wrap items-center gap-2 mb-3">
                ...
                <span
                  className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-1 shadow-sm ${tenantBadge.color}`}
                >
                ...
                <div className="relative pl-2">
                  ...
                  <div className="flex items-start gap-4 relative">
                    <div className="flex flex-col items-center">
                      ...
                      <div className="w-0.5 h-14 bg-gray-300 absolute top-4 left-[7px]"></div>
                    </div>
                    <div className="pb-6">
                  ...
                  <div className="flex items-start gap-4 relative">
                    ...
                    <div>
                      ...
                      <span className="inline-block mt-1 px-2.5 py-1 bg-blue-100 text-blue-700 text-xs font-bold rounded-full shadow-sm">
